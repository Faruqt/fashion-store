...
# The model to use to represent a User. You can override this with AUTH_USER_MODEL.
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": False,  # If True, a new refresh token is issued with each access token refresh
